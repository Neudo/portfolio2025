...
export default function Modal() {
  const { isModalOpen, modalTitle, modalContent, modalType, closeModal } =
    useModalStore();
  ...
  return (
    <>
      ...
      ></div>
      <div className="modal-content absolute top-0 left-0 z-50 w-full md:w-1/2 h-screen bg-white p-4">
        <button
